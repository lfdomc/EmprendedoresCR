...
import SideBanner from '@/components/ads/side-banner';
...
export function PageNavigation({ searchQuery, onSearchChange, placeholder }: PageNavigationProps) {
  ...
  return (
    <div className="w-full">
      {/* Layout con anuncios laterales en pantallas grandes */}
      <div className="hidden lg:flex items-start justify-center gap-4 max-w-7xl mx-auto">
        {/* Anuncio lateral izquierdo */}
        <SideBanner adSlot="3595693056" className="flex-shrink-0" />
        
        {/* Contenido principal centrado al 70% */}
